using GlobalFlights.ExternalServices.Providers.Amadeus.Enums;
...
namespace GlobalFlights.ExternalServices.Providers.Amadeus.Models
{
    ...
    public record SearchRequest(string Origin, string DepartureDate, bool? OneWay, int? Duration, bool? NonStop, ResultViewBy? ViewBy, int? MaxPrice, string[] IncludedAirlineCodes, string[] ExcludedAirlineCodes, string TravelClass, string CurrencyCode)
    {
