...
namespace GlobalFlights.ExternalServices.Providers.Lufthansa.Models
{
    // Represents the root response from the Lufthansa API
    public record SearchLufthansaResponse(
        List<FlightData> Data,
        Meta Meta,
        string? ProviderCode="LFS"
    );
